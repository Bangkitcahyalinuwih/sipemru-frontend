import LoginAdminForm from "../components/LoginComponent";
...
const AdminLoginPage = () => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#020617]">
      ...
      <div className="absolute left-0 top-0 h-72 w-72 animate-pulse rounded-full bg-cyan-400/10 blur-3xl" />
      <div className="absolute bottom-0 right-0 h-72 w-72 animate-pulse rounded-full bg-blue-500/10 blur-3xl delay-1000" />
